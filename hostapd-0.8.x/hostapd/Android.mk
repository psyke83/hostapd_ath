...
L_CFLAGS += -Iexternal/hostapd-0.6.8/hostapd$(HOSTAPD_VER)/src
L_CFLAGS += -Iexternal/hostapd-0.6.8/hostapd$(HOSTAPD_VER)/src/crypto
L_CFLAGS += -Iexternal/hostapd-0.6.8/hostapd$(HOSTAPD_VER)/src/utils
L_CFLAGS += -Iexternal/hostapd-0.6.8/hostapd$(HOSTAPD_VER)/src/common
